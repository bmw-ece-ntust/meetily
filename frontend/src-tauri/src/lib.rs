...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            api_client::commands::certify_meeting,
            ...
            api_client::commands::update_person,
            api_client::commands::delete_person,
            api_client::commands::list_person_samples,
            api_client::commands::add_person_sample,
            ...
            api_client::commands::list_bot_platforms,
            api_client::commands::list_bots,
            api_client::commands::get_bot,
            api_client::commands::create_bot,
            api_client::commands::delete_bot,
